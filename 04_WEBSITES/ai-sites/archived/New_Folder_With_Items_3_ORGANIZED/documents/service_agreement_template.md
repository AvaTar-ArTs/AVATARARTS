...
**Client**: [Client Name]
**Service Provider**: Steven Choake, QuantumForge Labs
...
- Client retains ownership of their data and requirements
- Service provider retains ownership of general methodologies and tools
- Custom code developed specifically for client becomes client property
...
Service provider's liability limited to total project cost.

### 8. Governing Law
This agreement governed by [State] law.

**Client Signature**: _________________ Date: _______
**Service Provider Signature**: Steven Choake Date: _______
