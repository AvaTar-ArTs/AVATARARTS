...
true, writable:
	...
	function T$5(n2, l2, u2, t2, i2) {
		var o3;
n:
		if ("style" === l2) if ("string" == typeof u2) n2.style.cssText = u2;
			else {
...
n:
	...
	n$2 = s$7.slice, l$5 = { __e:
	function(n2, l2, u2, t2) {
	...
	(function(module, exports) {
		(function(root2, factory) {
			...
			return {
				 ...
				 */
on:
				function(cssSelectors, callback) {
					if (!callback) return;
					if (!styleEl) {
...
conversationNodes:
	...
	function k$2(n2) {
		...
		"function"
		== typeof u2 && (n2.__c = void 0, u2()), r$4 = t2;
	}
	function w$3(n2) {
		var t2 = r$4;
		n2.__c = n2.__(), r$4 = t2;
...
right:
			offsets[2],
gap:
			Math.max(0, windowWidth - documentWidth + offsets[2] - offsets[0])
		};
	};
...
, options:
	...
	const P = function(t2) {
		let { strategy: e2 = "referenceHidden", ...n2 } = void 0 === t2 ? {} :
		        t2;
		return { name: "hide"
		, async fn(t3) {
			const { rects: r2 } = t3;
	...
	const T$2 = function(r2) {
		return void 0 === r2 && (r2 = 0), { name: "offset"
		                                    , options:
		r2, async fn(i2) {
			const { x: o3, y: a2 } = i2, l2 = await async function(r3, i3) {
				...
				let { mainAxis: p2, crossAxis: h2, alignmentAxis: y2 } = "number" == typeof d2 ? { mainAxis: d2, crossAxis: 0, alignmentAxis: null } : {
				            mainAxis: 0, crossAxis: 0, alignmentAxis:
				            null, ...d2
				        };
				return f2 && "number" == typeof y2 && (h2 = "end" === f2 ? -1 * y2 : y2), u2 ? { x: h2 * g2, y: p2 * m2 } : {
				           x:
				           p2 * m2, y:
				           h2 * g2
				       };
	...
	const D$2 = function(e2) {
		return void 0 === e2 && (e2 = {}), { name: "shift"
		                                     , options:
		e2, async fn(r2) {
			const { x: i2, y: o3, placement: a2 } = r2, { mainAxis:
			                                              l2 = true, crossAxis:
			                                              c2 = false, limiter:
			                                              f2 = { fn:
			(t2) => {
...
return { x: e3, y: n2 };
			                                            ...
			                                            } = e2, g2 = { x: i2, y: o3 }, d2 = await s$5(r2, m2), p2 = n$1(t$1(a2)), h2 = O(p2);
		...
		e2, fn(r2) {
			...
			const y2 = "function" == typeof c2 ? c2({ ...l2, placement: a2 }) : c2, x2 = "number" == typeof y2 ? { mainAxis: y2, crossAxis: 0 } : {
			               mainAxis: 0, crossAxis: 0, ...y2
			           };
			if (f2) {
		...
		return void 0 === n2 && (n2 = {}), { name: "size"
		                                     , options:
		n2, async fn(r2) {
			const { placement: i2, rects: o3, platform: a2, elements: l2 } = r2, { apply: c2, ...u2 } = n2, m2 = await s$5(r2, u2), g2 = t$1(i2), d2 = e$1(i2);
			let p2, h2;
			"top"
			=== g2 || "bottom" === g2 ? (p2 = g2, h2 = d2 === (await (null == a2.isRTL ? void 0 : a2.isRTL(l2.floating)) ? "start" : "end") ? "left" : "right") : (h2 = g2, p2 = "end" === d2 ? "top" : "bottom");
	...
	function y$3(t2) {
		return f$1(t2) ? { scrollLeft: t2.scrollLeft, scrollTop: t2.scrollTop } : {
		           scrollLeft:
		           t2.pageXOffset, scrollTop:
		           t2.pageYOffset
		       };
	}
	function x(t2) {
...
padding:
			collisionPadding,
boundary:
			boundary.filter($cf1ac5d9fe0e8206$var$isNotNull),
...
precheck: function precheck(i18nInstance2, loadNotPending) {
	...
	var matchHtmlEntity = /&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);
	/g;
	var htmlEntities = {
"&amp;": "&"
		,
			...
			if (lng && lng.toLowerCase() === "cimode") {
				if (appendNamespaceToCIMode) {
					...
					if (returnDetails) {
						return {
res: ""
							.concat(namespace).concat(nsSeparator).concat(key2),
usedKey:
							key2,
exactUsedKey:
							key2,
...
var Formatter = function() {
	function Formatter2() {
		...
		this.formats = {
number:
			createCachedFormatter(function(lng, opt) {
...
pending:
				Object.keys(pending),
toLoadLanguages:
				Object.keys(toLoadLanguages),
toLoadNamespaces:
				Object.keys(toLoadNamespaces)
			};
		}
	}, {
key: "loaded",
...
escapeValue:
			true,
format:
			function format(value, _format, lng, options) {
				return value;
			},
prefix: "{{"
			,
...
hasLoadedNamespace:
				clone.hasLoadedNamespace.bind(clone)
			};
...
"Exporter Settings": "Ajustes De ExportaciC3n",
"Export Dialog Title": "Exportar Conversaciones",
"Invalid File Format": "Formato de archivo invC!lido",
"Export from official export file": "Exportar desde archivo de exportaciC3n oficial",
"Export from API": "Exportar desde API",
"Available variables": "Variables Disponibles",
"Conversation Timestamp": "Marca de Tiempo",
"Conversation Timestamp Description": "AparecerC! en la pC!gina.",
...
"Export Format": "Formato de ExportaciC3n",
"Export Metadata": "Exportar Metadatos",
"Export Metadata Description": "AC1adir Metadatos a los archivos Markdown y HTML exportados.",
"OpenAI Official Format": "Formato Oficial de OpenAI",
"Conversation Archive Alert": "B?EstC!s seguro que quieres archivar todas las conversaciones seleccionadas?",
"Conversation Archived Message": "Todos las conversaciones seleccionadas se han archivado. Por favor refresca la pC!gina para ver los cambios.",
"Conversation Delete Alert": "B?EstC!s seguro que quieres borrar todas las conversaciones seleccionadas?",
"Conversation Deleted Message": "Todos las conversaciones seleccionadas se han borrado. Por favor refresca la pC!gina para ver los cambios.",
"Please start a conversation first": "Por favor empieza una conversaciC3n antes."
};
const title$6 = "Exportateur ChatGPT";
                const ExportHelper$6 = "Exporter";
                const Setting$6 = "ParamC(tre";
                const Language$6 = "Langue";
                const Screenshot$6 = "Capture d'C)cran";
...
"Exporter Settings": "ParamC(tres de l'exportateur",
...
"Export Metadata": "Exporter les mC)tadonnC)es",
"Export Metadata Description": "Ajouter des mC)tadonnC)es aux fichiers Markdown et HTML exportC)s.",
"OpenAI Official Format": "Format officiel OpenAI",
"Conversation Archive Alert": "C
tes-vous sC;r de vouloir archiver toutes les conversations sC)lectionnC)es ?",
"Conversation Archived Message": "Toutes les conversations sC)lectionnC)es ont C)tC) archivC)es. Veuillez actualiser la page pour voir les changements.",
"Conversation Delete Alert": "C
tes-vous sC;r de vouloir supprimer toutes les conversations sC)lectionnC)es ?",
"Conversation Deleted Message": "Toutes les conversations sC)lectionnC)es ont C)tC) supprimC)es. Veuillez actualiser la page pour voir les changements.",
...
const title$4 = "ChatGPTc(c/c9cc<c?c<";
                const ExportHelper$4 = "c(c/c9cc<c";
                const Setting$4 = "h(-e.";
                const Language$4 = "h( h*";
                const Screenshot$4 = "c9c/c*c<c3c7c'cc";
                const Markdown$4 = "Markdown";
                const HTML$4 = "HTML";
                const Archive$4 = "c"c<c+c$c";
                const Save$4 = "d?e-";
                const Delete$4 = "e
i$";
                const Export$4 = "c(c/c9cc<c";
                const Loading$4 = "h*-c?h><c?d8-";
                const Preview$4 = "cc,cc%c<";
const ja_JP = {
title: title$4,
ExportHelper: ExportHelper$4,
Setting: Setting$4,
Language: Language$4,
"Copy Text": "cc-c9ccc3cc<",
"Copied!": "c3cc<cc>cco<",
...
"File Name": "cc!c$c+e
",
"Export All": "cc9c&c(c/c9cc<c",
"Exporter Settings": "c(c/c9cc<c?c<h(-e.",
"Export Dialog Title": "d<h)1cc(c/c9cc<c",
"Invalid File Format": "g!e
9c*cc!c$c+e="e<",
"Export from official export file": "e,e<c(c/c9cc<ccc!c$c+cc	c(c/c9cc<ccc",
"Export from API": "APIcc	c(c/c9cc<ccc",
"Available variables": "d=?g(e/h=c*e$	f0",
"Conversation Timestamp": "d<h)1c.c?c$c c9c?c3c",
"Conversation Timestamp Description": "cc<c8c+h!(g$:ccc>cc ",
"Enable on HTML": "HTML cc!c$c+c'f	e
9c+cc",
"Enable on Markdown": "Markdown cc!c$c+c'f	e
9c+cc",
"Use 24-hour format": "24fie="e<cd=?g(cc (d>: 23:59)",
"Export Format": "c(c/c9cc<ccc)c<ccc",
"Export Metadata": "c!c?cc<c?cc(c/c9cc<c",
"Export Metadata Description": "c(c/c9cc<ccccMarkdownc
cc3HTMLcc!c$c+c+c!c?cc<c?ch?=e
 cc>cc ",
"OpenAI Official Format": "OpenAIe,e<cc)c<ccc",
"Conversation Archive Alert": "i8f
cccc9c&c.d<h)1cc"c<c+c$ccc&ccc
ccc'cco<",
"Conversation Archived Message": "i8f
cccc9c&c.d<h)1cc"c<c+c$cccc>ccc e$	f4ch!(g$:ccc+c/c cc<c8cf4f0cc&cc ccc ",
"Conversation Delete Alert": "i8f
cccc9c&c.d<h)1ce
i$cc&ccc
ccc'cco<",
"Conversation Deleted Message": "i8f
cccc9c&c.d<h)1ce
i$ccc>ccc e$	f4ch!(g$:ccc+c/c cc<c8cf4f0cc&cc ccc ",
"Please start a conversation first": "c>cd<h)1cie'cc&cc ccc "
};
const title$3 = "ChatGPT Exporter";
                const ExportHelper$3 = "Export";
                const Setting$3 = "PP0Q P0P<P5QQ Q";
                const Language$3 = "P/P7QP:";
                const Screenshot$3 = "P!P:Q P8P=QP>Q";
                const Markdown$3 = "Markdown";
                const HTML$3 = "HTML";
                const Archive$3 = "PQ QP8P2P8Q P>P2P0QQ";
                const Save$3 = "P!P>QQ P0P=P8QQ";
                const Delete$3 = "P#P4P0P;P8QQ";
                const Export$3 = "P-P:QP?P>Q Q";
                const Loading$3 = "PP0P3Q QP7P:P0";
                const Preview$3 = "PQ P5P4P?Q P>QP<P>QQ ";
const ru = {
title: title$3,
ExportHelper: ExportHelper$3,
Setting: Setting$3,
Language: Language$3,
"Copy Text": "PP>P?P8Q P>P2P0QQ QP5P:QQ",
"Copied!": "P!P:P>P?P8Q P>P2P0P=P>!",
...
Save: Save$3,
Delete: Delete$3,
"Select All": "PQP1Q P0QQ P2QP5",
Export: Export$3,
"Error": "PQP8P1P:P0",
Loading: Loading$3,
Preview: Preview$3,
"File Name": "PP<Q QP0P9P;P0",
"Export All": "P-P:QP?P>Q QP8Q P>P2P0QQ P2QP5",
"Exporter Settings": "PP0Q P0P<P5QQ Q Q
P:QP?P>Q QP0",
"Export Dialog Title": "P-P:QP?P>Q QP8Q P>P2P0QQ P1P5QP5P4Q",
"Invalid File Format": "PP5P2P5Q P=QP9 QP>Q P<P0Q QP0P9P;P0",
"Export from official export file": "P-P:QP?P>Q Q P8P7 P>QP8QP8P0P;QP=P>P3P> QP0P9P;P0",
"Export from API": "P-P:QP?P>Q Q P8P7 API",
"Available variables": "PP>QQQP?P=QP5 P?P5Q P5P<P5P=P=QP5",
"Conversation Timestamp": "PQ P5P<P5P=P=P0Q P<P5QP:P0 Q P0P7P3P>P2P>Q P0",
"Conversation Timestamp Description": "PQP4P5Q P>QP>P1Q P0P6P0QQQQ P=P0 QQQ P0P=P8QP5.",
"Enable on HTML": "PP:P;QQP8QQ P4P;Q HTML-QP0P9P;P>P2",
"Enable on Markdown": "PP:P;QQP8QQ P4P;Q QP0P9P;P>P2 Markdown",
"Use 24-hour format": "PQP?P>P;QP7P>P2P0QQ 24-QP0QP>P2P>P9 QP>Q P<P0Q (P=P0P?Q P8P<P5Q , 23:59)",
"Export Format": "P$P>Q P<P0Q Q
P:QP?P>Q QP0",
"Export Metadata": "P-P:QP?P>Q Q P<P5QP0P4P0P=P=QQ",
"Export Metadata Description": "PP>P1P0P2P;QP9QP5 P<P5QP0P4P0P=P=QP5 P2 Q
P:QP?P>Q QP8Q P>P2P0P=P=QP5 QP0P9P;Q Markdown P8 HTML.",
"OpenAI Official Format": "PQP8QP8P0P;QP=QP9 QP>Q P<P0Q OpenAI",
"Conversation Archive Alert": "PQ QP2P5Q P5P=Q, QQP> QP>QP8QP5 P0Q QP8P2P8Q P>P2P0QQ P2QP5 P2QP1Q P0P=P=QP5 Q P0P7P3P>P2P>Q Q?",
"Conversation Archived Message": "PQP5 P2QP1Q P0P=P=QP5 Q P0P7P3P>P2P>Q Q P1QP;P8 P7P0P0Q QP8P2P8Q P>P2P0P=Q. PP>P6P0P;QP9QQP0, P>P1P=P>P2P8QP5 QQQ P0P=P8QQ, QQP>P1Q QP2P8P4P5QQ P8P7P<P5P=P5P=P8Q.",
"Conversation Delete Alert": "PQ QP2P5Q P5P=Q, QQP> QP>QP8QP5 QP4P0P;P8QQ P2QP5 P2QP1Q P0P=P=QP5 Q P0P7P3P>P2P>Q Q?",
"Conversation Deleted Message": "PQP5 P2QP1Q P0P=P=QP5 Q P0P7P3P>P2P>Q Q P1QP;P8 QP4P0P;P5P=Q. PP>P6P0P;QP9QQP0, P>P1P=P>P2P8QP5 QQQ P0P=P8QQ, QQP>P1Q QP2P8P4P5QQ P8P7P<P5P=P5P=P8Q.",
"Please start a conversation first": "PP>P6P0P;QP9QQP0, P=P0QP=P8QP5 Q P0P7P3P>P2P>Q  P?P5Q P2QP<."
};
const title$2 = "ChatGPT Exporter";
                const ExportHelper$2 = "DD1Ea Aktar";
                const Setting$2 = "Ayarlar";
                const Language$2 = "Dil";
                const Screenshot$2 = "Ekran AlD1ntD1sD1";
                const Markdown$2 = "Markdown";
                const HTML$2 = "HTML";
                const Archive$2 = "ArEiv";
                const Save$2 = "Kaydet";
                const Delete$2 = "Sil";
                const Export$2 = "DD1Ea Aktar";
                const Loading$2 = "YC<kleniyor";
                const Preview$2 = "Cnizleme";
const tr_TR = {
title: title$2,
...
Save: Save$2,
Delete: Delete$2,
"Select All": "TC<mC<nC< SeC'",
Export: Export$2,
"Error": "Hata",
Loading: Loading$2,
Preview: Preview$2,
"File Name": "Dosya AdD1",
"Export All": "TC<mC<nC< DD1Ea Aktar",
"Exporter Settings": "DD1Ea Aktarma AyarlarD1",
"Export Dialog Title": "KonuEmalarD1 DD1Ea Aktar",
"Invalid File Format": "Dosya BiC'imi GeC'ersiz",
"Export from official export file": "Resmi dD1Ea aktarma dosyasD1ndan dD1Ea aktar",
"Export from API": "API'den dD1Ea aktar",
"Available variables": "KullanD1labilir deDiEkenler",
"Conversation Timestamp": "KonuEma zaman bilgisi",
"Conversation Timestamp Description": "Sayfada gC6sterilir.",
"Enable on HTML": "HTML dosyalarD1nda etkinleEtir",
"Enable on Markdown": "Markdown dosyalarD1nda etkinleEtir",
"Use 24-hour format": "24 saat biC'imini kullan (C6rn. 23:59)",
"Export Format": "DD1Ea Aktarma FormatD1",
"Export Metadata": "Cst veriyi dD1Ea aktar",
"Export Metadata Description": "DD1Ea aktarD1lan Markdown ve HTML dosyalarD1na C<st veri ekle",
"OpenAI Official Format": "OpenAI Resmi Format",
"Conversation Archive Alert": "SeC'ilen tC<m konuEmalarD1 arEivlemek istediDinizden emin misiniz?",
"Conversation Archived Message": "SeC'ilen tC<m konuEmalar arEivlendi. DeDiEiklikleri gC6rmek iC'in sayfayD1 yenileyin.",
"Conversation Delete Alert": "SeC'ilen tC<m konuEmalarD1 silmek istediDinizden emin misiniz?",
"Conversation Deleted Message": "SeC'ilen tC<m konuEmalar silindi. DeDiEiklikleri gC6rmek iC'in sayfayD1 yenileyin.",
"Please start a conversation first": "LC<tfen C6nce bir konuEma baElatD1n."
};
const title$1 = "ChatGPT Exporter";
                const ExportHelper$1 = "e/<e:e
)f	";
                const Setting$1 = "h.>g=.";
                const Language$1 = "h/-h( ";
                const Screenshot$1 = "f*e1";
...
",
"Export All": "f	9ie/<e:",
"Exporter Settings": "e/<e:h.>g=.",
"Export Dialog Title": "e/<e:e/9h/",
"Invalid File Format": "f fgfd;6f <e<",
"Export from official export file": "d;e.f9e/<e:fd;6e/<e:",
"Export from API": "d; API e/<e:",
"Available variables": "e/g(ei",
"Conversation Timestamp": "e/9h/f6i4f3",
"Conversation Timestamp Description": "d<f>g$:e(i!5i"d8
c ",
"Enable on HTML": "e( HTML fd;6d8
e/g(",
"Enable on Markdown": "e( Markdown fd;6d8
e/g(",
"Use 24-hour format": "d=?g(24e0f6e6 (d>e& 23:59)",
"Export Format": "e/<e:f <e<",
"Export Metadata": "e/<e:ef0f
.",
"Export Metadata Description": "d<f7;e
 h3 Markdown d;%e
 HTML e/<e:c ",
"OpenAI Official Format": "OpenAI e.f9f <e<",
"Conversation Archive Alert": "g!.e.h&e=f!#f	 f	i 	ege/9h/o<",
"Conversation Archived Message": "f	 f	f	 i 	ge/9h/e72e=f!#c h/7e7f0i!5i"c ",
"Conversation Delete Alert": "g!.e.h&e i$f	 f	i 	ege/9h/o<",
"Conversation Deleted Message": "f	 f	f	 i 	ge/9h/e72e i$c h/7e7f0i!5i"c ",
"Please start a conversation first": "h/7ee< e'e/9h/c "
};
const title = "ChatGPT Exporter";
              const ExportHelper = "Export";
              const Setting = "h(-e.";
              const Language = "h*h( ";
              const Screenshot = "f*e";
...
g(1",
"Export All": "f	9ie/e:",
"Exporter Settings": "h(-e.",
"Export Dialog Title": "e/e:e0
h)1",
"Invalid File Format": "g!fgf*f!f <e<",
"Export from official export file": "e>e.f9e/e:f*f!e/e:",
"Export from API": "e> API e/e:",
"Available variables": "e/g(h.
f8",
"Conversation Timestamp": "e0
h)1fif3",
"Conversation Timestamp Description": "fi!/g$:e(i i"d8
c ",
"Enable on HTML": "e( HTML f*f!d8
eg(",
"Enable on Markdown": "e( Markdown f*f!d8
eg(",
"Use 24-hour format": "d=?g(24e0fe6 (d>e& 23:59)",
"Export Format": "e/e:f <e<",
"Export Metadata": "e/e:eh3f",
"Export Metadata Description": "ff7;e
 h3 Markdown d;%e
 HTML e/e:c ",
"OpenAI Official Format": "OpenAI e.f9f <e<",
"Conversation Archive Alert": "g":e.h&e0e-f	 f	i8ege0
h)1o<",
"Conversation Archived Message": "f	 f	i8ege0
h)1e72e0e-c h+i
f0f4gi i"c ",
"Conversation Delete Alert": "g":e.h&e*i$f	 f	i8ege0
h)1o<",
"Conversation Deleted Message": "f	 f	i8ege0
h)1e72e*i$c h+i
f0f4gi i"c ",
"Please start a conversation first": "h+eie'e0
h)1c "
};
class GMStorage {
	static get(key2) {
...
body {
font-family: SC6hne,ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif,Helvetica Neue,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;
	font-size: 14px;
	line-height: 1.5;
color: var(--page-text);
...
pre>code {
font-family: SC6hne Mono, Monaco, Andale Mono, Ubuntu Mono, monospace !important;
	font-weight: 400;
font-size: .875em;
...
settings:
		{
omitOptionalTags:
			options_.omitOptionalTags || false,
allowParseErrors:
			options_.allowParseErrors || false,
allowDangerousCharacters:
			options_.allowDangerousCharacters || false,
quoteSmart:
			options_.quoteSmart || false,
preferUnquoted:
			options_.preferUnquoted || false,
tightAttributes:
			options_.tightAttributes || false,
upperDoctype:
			options_.upperDoctype || false,
tightDoctype:
			options_.tightDoctype || false,
bogusComments:
			options_.bogusComments || false,
tightCommaSeparatedLists:
			options_.tightCommaSeparatedLists || false,
tightSelfClosing:
			options_.tightSelfClosing || false,
collapseEmptyAttributes:
			options_.collapseEmptyAttributes || false,
allowDangerousHtml:
			options_.allowDangerousHtml || false,
voids:
			options_.voids || htmlVoidElements,
characterReferences:
			options_.characterReferences || options_.entities || {},
closeSelfClosing:
			options_.closeSelfClosing || false,
closeEmptyElements:
			options_.closeEmptyElements || false
		},
schema:
		options_.space === "svg" ? svg : html$4,
		quote,
		alternative
	};
	return state.one(
...
_tokenizer: childFlow
	...
	function writeToChild(token, eof) {
		...
		if (self2.parser.lazy[token.start.line]) {
			...
			while (index2--) {
				if (
				    // The token starts before the line endingb &
				    childFlow.events[index2][1].start.offset < lineStartOffset && // b &and either is not ended yetb &
				    (!childFlow.events[index2][1].end || // b &or ends after it.
		...
		if (events[index2][0] === "enter" && events[index2][1].type === "attentionSequence" && events[index2][1]._close) {
			...
			while (open--) {
				if (events[open][0] === "exit" && events[open][1].type === "attentionSequence" && events[open][1]._open && // If the markers are the same:
					...
					openingSequence = {
type:
						use > 1 ? "strongSequence" : "emphasisSequence",
						start,
...
type:
						...
						Object.assign({}, events[index2][1].start)
					};
					group = {
type:
						...
						Object.assign({}, closingSequence.end)
					};
...
function factoryLabel(effects, ok2, nok, type, markerType, stringType) {
	...
	function atBreak(code2) {
		if (code2 === null || code2 === 91 || code2 === 93 && !data || /* To do: remove in the future once web ve switched from
       * `micromark-extension-footnote` to `micromark-extension-gfm-footnote`,
       * which doesnb t need this */
...
type: "atxHeadingText"
			,
start:
			events[contentStart][1].start,
end:
			events[contentEnd][1].end
		};
		text2 = {
type: "chunkText"
			,
...
function resolveToLabelEnd(events, context) {
	...
	const group = {
type:
		events[open][1].type === "labelLink" ? "link" : "image",
		start: Object.assign({}, events[open][1].start),
end:
		Object.assign({}, events[events.length - 1][1].end)
	};
	const label = {
type: "label"
		,
start:
		Object.assign({}, events[open][1].start),
end:
		Object.assign({}, events[close][1].end)
	};
	const text2 = {
type: "labelText"
		,
start:
		Object.assign({}, events[open + offset + 2][1].end),
end:
		Object.assign({}, events[close - 2][1].start)
	};
	media = [
	            ["enter", group, context],
	            ["enter", label, context]
...
_container: true
	...
	function atMarker(code2) {
		...
		return effects.check(
		           blankLine,
		           // Canb t be empty when interrupting.
...
type: "setextHeading"
		,
start:
		Object.assign({}, events[text2][1].start),
end:
		Object.assign({}, events[events.length - 1][1].end)
	};
...
exit:
		exit2,
attempt:
		constructFactory(onsuccessfulconstruct),
check:
		constructFactory(onsuccessfulcheck),
interrupt:
		constructFactory(onsuccessfulcheck, {
interrupt: true
		})
			...
			function handleConstruct(construct) {
				...
				function start(code2) {
					...
					return construct.tokenize.call(
					           ...
					           // prototype.
					           // This allows a b live bindingb , which is needed for `interrupt`.
...
codeFencedFenceMeta:
			buffer,
codeIndented:
			opener(codeFlow, buffer),
codeText:
			opener(codeText2, buffer),
codeTextData:
			onenterdata,
data:
			onenterdata,
...
listItem:
			opener(listItem2),
listItemValue:
			onenterlistitemvalue,
listOrdered:
			opener(list2, onenterlistordered),
listUnordered:
			opener(list2),
paragraph:
			opener(paragraph2),
...
atxHeading:
			closer(),
atxHeadingSequence:
			onexitatxheadingsequence,
autolink:
			closer(),
autolinkEmail:
			onexitautolinkemail,
autolinkProtocol:
			onexitautolinkprotocol,
blockQuote:
			closer(),
...
characterReferenceValue:
			onexitcharacterreferencevalue,
codeFenced:
			closer(onexitcodefenced),
codeFencedFence:
			onexitcodefencedfence,
codeFencedFenceInfo:
			onexitcodefencedfenceinfo,
codeFencedFenceMeta:
			onexitcodefencedfencemeta,
codeFlowValue:
			onexitdata,
codeIndented:
			closer(onexitcodeindented),
codeText:
			closer(onexitcodetext),
codeTextData:
			onexitdata,
data:
			onexitdata,
...
definitionLabelString:
			onexitdefinitionlabelstring,
definitionTitleString:
			onexitdefinitiontitlestring,
emphasis:
			closer(),
hardBreakEscape:
			closer(onexithardbreak),
hardBreakTrailing:
			closer(onexithardbreak),
htmlFlow:
			closer(onexithtmlflow),
htmlFlowData:
			onexitdata,
htmlText:
			closer(onexithtmltext),
htmlTextData:
			onexitdata,
image:
			closer(onexitimage),
...
paragraph:
			closer(),
referenceString:
			onexitreferencestring,
resourceDestinationString:
			onexitresourcedestinationstring,
resourceTitleString:
			onexitresourcetitlestring,
resource:
			onexitresource,
setextHeading:
			closer(onexitsetextheading),
setextHeadingLineSequence:
			onexitsetextheadinglinesequence,
setextHeadingText:
			onexitsetextheadingtext,
strong:
			closer(),
thematicBreak:
			closer()
...
_spread:
						false,
start:
						Object.assign({}, event[1].start),
						// @ts-expect-error: web ll add `end` in a second.
end:
						void 0
					};
...
function(tree, find2, replace2, options) {
	...
	function visitor(node2, parents) {
		...
		while (++index2 < parents.length) {
			...
			if (ignored(
			            parent,
			            // @ts-expect-error: TS doesnb t understand but itb s perfect.
...
stack:
			...
			if (typeof value === "string") {
				value = value.length > 0 ? { type: "text", value } :
				        void 0;
			}
			if (value !== false) {
				if (start !== position2) {
...
title:
		null,
url:
		prefix + protocol + parts[0],
children:
[{ type: "text", value: protocol + parts[0] }]
	};
	if (parts[1]) {
...
handlers:
				{ footnoteDefinition, footnoteReference: footnoteReference$1 }
			};
		}
		...
		function markdownTable(table2, options = {}) {
			...
			while (++rowIndex < cellMatrix.length) {
				...
				while (++columnIndex < mostCellsPerRow) {
					...
					if (options.padding !== false && // Donb t add the opening space if web re not aligning and the cell is
...
properties:
				{},
children:
				state.wrap(state.all(node2), true)
			};
...
properties:
				{
href: "#"
					+ state.clobberPrefix + "fn-" + safeId,
    id:
					    state.clobberPrefix + "fnref-" + safeId + (reuseCounter > 1 ? "-" + reuseCounter : ""),
					    dataFootnoteRef:
					    true,
					    ariaDescribedBy:
					    ["footnote-label"]
...
type: "footnoteDefinition"
				...
				identifier,
children:
[{ type: "paragraph", children: node2.children }],
position:
				node2.position
			};
...
column:
					...
					// @ts-expect-error: in practice, null is allowed.
offset:
					point3.offset > -1 ? point3.offset : null
				};
			}
		}
...
children:
		...
		function one(state, node2, parent) {
			...
			if (state.passThrough && state.passThrough.includes(type)) {
				return "children" in node2 ? { ...node2, children: all(state, node2) } :
				       node2;
			}
...
properties:
						{
href: "#"
							+ state.clobberPrefix + "fnref-" + safeId + (referenceIndex > 1 ? "-" + referenceIndex : ""),
							    dataFootnoteBackref:
							    true,
							    className:
							    ["data-footnote-backref"],
							    ariaLabel:
							    state.footnoteBackLabel
						    },
children:
[{ type: "text", value: "b)" }]
					};
...
children: state.wrap(listItems, true)
		...
		function toHast(tree, options) {
			...
			return Array.isArray(node2) ? { type: "root", children: node2 } :
			       node2;
		}
		...
		function formatCodeAsIndented(node2, state) {
			return Boolean(
			           !state.options.fences && node2.value && // If thereb s no infob &
			           !node2.lang && // And thereb s a non-whitespace characterb &
			           /[^ \r\n]/.test(node2.value) && // And the value doesnb t start or end in a blankb &
			           !/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(node2.value)
			       );
		}
...
after: "\n",
		...
		function image(node2, _24, state, info) {
			...
			subexit();
			if (
			    // If thereb s no url but there is a titleb &
...
after: "]",
		...
		function formatLinkAsAutolink(node2, state) {
			...
			return Boolean(
			           !state.options.resourceLink && // If thereb s a urlb &
			           node2.url && // And thereb s a no titleb &
			           !node2.title && // And the content of `node` is a single text nodeb &
			           node2.children && node2.children.length === 1 && node2.children[0].type === "text" && // And if the url is the same as the contentb &
			                   (raw2 === node2.url || "mailto:" + raw2 === node2.url) && // And that starts w/ a protocolb &
			                   /^[a-z][a-z+.-]+:/i.test(node2.url) && // And that doesnb t contain ASCII control codes (character escapes and
			                   // references donb t work), space, or angle bracketsb &
			                   !/[\0- <>\u007F]/.test(node2.url)
			       );
		}
		link.peek = linkPeek;
...
join:
				[],
				// @ts-expect-error: web ll fill it next.
handlers:
				{},
options:
				{},
indexStack:
				[],
				// @ts-expect-error: web ll add `handle` later.
handle:
				void 0
			};
...
continuation:
						{
tokenize:
							tokenizeDefinitionContinuation
						},
exit:
						gfmFootnoteDefinitionEnd
					}
				},
text:
				{
...
resolveTo:
						resolveToPotentialGfmFootnoteCall
					}
				}
			};
		}
...
type: "gfmFootnoteCall"
				,
start:
				Object.assign({}, events[index2 + 3][1].start),
end:
				Object.assign({}, events[events.length - 1][1].end)
			};
			const marker = {
type: "gfmFootnoteCallMarker"
				,
start:
				Object.assign({}, events[index2 + 3][1].end),
end:
				Object.assign({}, events[index2 + 3][1].end)
			};
			marker.end.column++;
...
type: "gfmFootnoteCallString"
				,
start:
				Object.assign({}, marker.end),
end:
				Object.assign({}, events[events.length - 1][1].start)
			};
			const chunk = {
type: "chunkString"
				,
contentType: "string"
				,
start:
				Object.assign({}, string2.start),
end:
				Object.assign({}, string2.end)
			};
			const replacement = [
...
start:
									...
									Object.assign({}, events[index2][1].end)
								};
								const text2 = {
type: "strikethroughText"
									,
start:
									Object.assign({}, events[open][1].end),
end:
									Object.assign({}, events[index2][1].start)
								};
								const nextEvents = [
...
type: "table"
							,
start:
							Object.assign({}, token.start),
							// Note: correct end is set later.
end:
							Object.assign({}, token.end)
						};
...
type:
					valueName,
start:
					Object.assign({}, relatedStart),
end:
					Object.assign({}, relatedEnd)
				};
...
compressionOptions: {
			...
			const conversationHtml = conversationNodes.map(({ message }) => {
				...
				if (message.author.role === "assistant") {
					...
					postSteps.push((input) => {
						...
						if (!isCodeBlock && matches) {
							transformed = transformed.replace(/b,(\d+)b,/g, (_24, index2) => {
		...
		function transformFootNotes$2(input, metadata) {
			const footNoteMarkRegex = /c (\d+)b  \((.+?)\)c /g;
...
#thread [data-testid^="conversation-turn-"] {
                    color:
				                    $ {isDarkMode ? "#ececec" : "#0d0d0d"};
background-color:
				$ {isDarkMode ? "#212121" : "#fff"};
			}
...
function convertMessageToTavern(node2) {
	...
	return {
name:
		authorRole === "assistant" ? "Assistant" : "You",
...
function transformMessage(message) {
	...
	if (matches) {
		content2 = content2.replace(/b,(\d+)b,/g, (_24, index2) => {
			return matches[+index2];
		});
	}
return `$ {author}:
...
function transformContent(content2, metadata) {
	...
	case "tether_browsing_display": {
			const metadataList = (_c = metadata == null ? void 0 : metadata._cite_metadata) == null ? void 0 : _c.metadata_list;
			if (Array.isArray(metadataList) && metadataList.length > 0) {
				return metadataList.map(({ title: title2, url }) => `> [$ {
					  title2
				  }]($ {url})`).join("\n");
			}
			return "";
...
className: "SelectItem", children: [
			...
			conversations.map((c2) => /* @__PURE__ */ o$8("li", {
...
function c$1(r2, t2 = {}, e$12, a2) {
	...
	"className"
	in o3 && o3.className && typeof o3.className == "function" && (o3.className = o3.className(t2));
	let p2 = {};
	if (t2) {
		let i2 = false, m2 = [];
	...
	if (s2 === k$3 && Object.keys(R(o3)).length > 0) {
		if (!an(l2) || Array.isArray(l2) && l2.length > 1) throw new Error(['Passing props on "Fragment"!', "", `The current component <$ {a2} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(o3).map((d2) => `  - $ {
			         d2
		         }`).join(`
		`), "", "You can apply a few solutions:", ['Add an `as="..."` prop, to ensure that we render an actual element instead of a "Fragment".', "Render a single element as the child so that we can forward the props onto that element."].map((d2) => `  - $ {
			d2
		}`).join(`
		         `)].join(`
		                  `));
...
function Z(s2) {
	var d2;
	let [n2, p2] = h$4(null), [c2, f2] = H(), [r2, h2] = M$1(), l2 = F$1(() => ( {
switch:
n2, setSwitch:
p2, labelledby:
c2, describedby:
		r2
	}), [n2, p2, c2, r2]), T2 = {}, b2 = s2;
...
function te(s2, n2) {
	...
	}), v2 = o$2((e2) => e2.preventDefault()), G2 = F$1(() => ( {
checked:
		o$12
	}), [o$12]), R$12 = { id: c$12, ref: D2, role: "switch", type: s$1(s2, u2), tabIndex: 0, "aria-checked": o$12, "aria-labelledby": t2 == null ? void 0 : t2.labelledby, "aria-describedby": t2 == null ? void 0 : t2.describedby, onClick: C2, onKeyUp: L2, onKeyPress: v2 }, k2 = p$2();
	return p$6(() => {
		var w2;
...
className: "space-y-6", children: [
 ...
 children: [
 /* @__PURE__ */ o$8("dt", { className: "text-md font-medium text-gray-800 dark:text-white", children: `${t2("Language")} p` }),
							/* @__PURE__ */ o$8("dd", {
children: /* @__PURE__ */ o$8(
								    "select",
								{
...
list2[i2] = { ...list2[i2], name: e2.currentTarget.value };
										...
										/* @__PURE__ */ o$8("span", { className: "mx-2", children: "b" }),
										/* @__PURE__ */ o$8(
										    "input",
										{
className: "Input",
