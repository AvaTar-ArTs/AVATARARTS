...
document.getElementById("hour").innerHTML = currentHours; hourtext[currentHours];
...
document.getElementById("weekday1").innerHTML = shortdays[currentTime.getDay()];
document.getElementById("weekday2").innerHTML = shortdays[currentTime.getDay()];
