...
(function() {
    ...
    function extractContentFromModal(modal) {
        ...
        const lines = allText
            ...
            .filter(
                (line) =>
                !line.match(
                    /^(Close|Download|Export|PDF|TEXT|Select|Cancel|OK|\d+\s*lines?|View|Edit)$/i
                )
            )
        ...
        console.log(
            `📄 Extracted ${content.length} characters using fallback method`
        );
        return content;
    }
    ...
    function findFileElements() {
        ...
        const knowledgePanel =
            document.querySelector('[class*="project"], [class*="knowledge"]') ||
            document;
            ...
            for (const element of elements) {
                ...
                if (
                    ...
                    (text.length > 10 &&
                        ...
                        !text.match(
                            /^(Export|Download|Close|Cancel|OK|Edit|View|Settings)$/i
                        ))
                ) {
